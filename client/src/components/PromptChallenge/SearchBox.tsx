...
export default function SearchBox () {
  ...
  <div className="max-w-[480px] w-full m-auto px-4">
    <div className="relative">
      <input type="text" name="q" className="bg-transparent text-white w-full border h-12 shadow p-4 rounded-full bg" placeholder="search" />
      <button type="submit">
        <svg className="text-white h-5 w-5 absolute top-3.5 right-3 fill-current" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 56.966 56.966" style={{enableBackground: 'new 0 0 56.966 56.966'}} xmlSpace="preserve">
