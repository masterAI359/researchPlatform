...
export default function BlueSkyPosts ({ context }) {
    ...
    return (
      ...
      >
        ...
        <div className="bg-gradientup mx-auto flex flex-col shrink-0 grow rounded-4xl w-full h-auto md:max-w-xl lg:max-w-3xl xl:max-w-4xl 2xl:min-w-6xl 2xl:max-w-7xl relative overflow-hidden">
