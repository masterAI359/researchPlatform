...
export default function ControlPanel({ }) {
    ...
    return (
        ...
        bottom-0 left-0 right-0 z-30 flex lg:w-[12rem] 2xl:w-fit shadow-black
         h-auto bg-black xl:bg-astro_black lg:rounded-full border-t md:border border-border_gray">
            ...
            <div className="shrink-0 w-fit lg:rounded-r-full h-auto px-2 py-0.5 xl:px-2 2xl:px-2.5 md:hover:bg-border_gray transition-all ease-in-out flex justify-center xs:border-r lg:border-0 border-border_gray">
                <TakeNotes />
            </div>
            {showContent && <div className="block lg:hidden grow shrink-0 justify-end w-fit h-auto py-1.5 xl:px-2 2xl:px-2.5 lg:hover:bg-border_gray transition-all ease-in-out flex justify-center lg:border-0 border-border_gray">
                <StoryPaginate />
            </div>}
        </div>
    )
