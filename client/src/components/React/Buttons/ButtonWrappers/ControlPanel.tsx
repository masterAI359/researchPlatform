...
export default function ControlPanel({ }) {
    ...
    return (
        <div className="fixed 2xl:left-12 2xl:bottom-12 xl:left-2 xl:bottom-6 md:left-6 md:bottom-6 
        bottom-0 left-0 right-0 z-30 flex xl:w-[12rem] 2xl:w-[13.22rem] shadow-black
         h-auto xs:bg-black xl:bg-astro_black md:rounded-full border-t md:border border-border_gray overflow-x-hidden">
            ...
            <div className="shrink-0 md:grow w-fit h-auto px-2 py-0.5 xl:px-2 2xl:px-2.5 md:hover:bg-border_gray transition-all ease-in-out flex justify-center xs:border-r lg:border-0 border-border_gray">
                <TakeNotes />
            </div>
            <div className="block md:hidden grow shrink-0 justify-end w-fit h-auto py-1.5 xl:px-2 2xl:px-2.5 md:hover:bg-border_gray transition-all ease-in-out flex justify-center lg:border-0 border-border_gray">
                <StoryPaginate />
            </div>
        </div>
    )
