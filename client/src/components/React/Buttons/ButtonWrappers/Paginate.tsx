...
border border-white/50 md:group-hover:opacity-100 transition-opacity duration-200 ease-in-out">
            ...
            <button
                ...
                className="xl:w-16 xl:h-12 bg-white hover:bg-white/10 rounded-2xl
...
border border-white/50 md:group-hover:opacity-100 transition-opacity duration-200 ease-in-out">
                ...
                <svg className="text-black p-1.5 group-hover:text-white transition-all duration-200 ease-in-out" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
