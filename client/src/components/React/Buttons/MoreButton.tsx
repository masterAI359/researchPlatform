...
export default function MoreButton({ article_url }) {
    ...
    return (
        <div className='w-fit h-fit xs:self-start md:self-end xl:mr-2 relative group'>
            <div className="rounded-md xl:h-fit xl:w-16 flex mx-auto bg:black/80 opacity-0 absolute xl:-translate-y-9 xl:-translate-x-8
border border-white/50 md:group-hover:opacity-100 transition-opacity duration-200 ease-in-out">
            ...
            ease-in-out xs:py-0.5 xs:px-2 rounded-xl'>
                <button
