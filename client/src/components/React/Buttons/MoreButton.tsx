...
export default function MoreButton({ article_url }) {
    ...
    return (
        <div className='w-fit h-fit xs:self-start md:self-end xl:mr-2 relative'>
            {open && <More key={article_url} article_url={article_url} setOpen={setOpen} />}
            <div className="group relative">
                {!open && <div className="rounded-md xl:h-fit xl:w-16 flex mx-auto bg:black/80 opacity-0 absolute xl:-translate-y-9 xl:-translate-x-8
