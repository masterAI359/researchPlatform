...
export default function BackToSavedArticles() {
    ...
    return (
        <button onClick={backToSaved} className="absolute top-2 -left-10 sm:fixed sm:top-1/2 sm:left-12 text-white font-light w-12 h-6
          lg:w-14 lg:h-12 p-1 sm:p-1.5 transition-all flex justify-start sm:justify-center shadow-blue-bottom
          ...
          rounded-2xl">
            ...
            <span className="flex items-center justify-center h-fit w-full p-1 sm:p-0">
                <svg className={`sm:p-3 w-7 h-7 p-1 mx-auto rounded-full text-black group-hover:text-white`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
