...
export function FinishedReading({ }) {
    ...
    return (
        ...
        2xl:max-h-8 p-0.5 ease-in-out group relative">
            ...
            {showReadingTooltip ? <GuideDoneReading /> : <div className="fixed rounded-md z-50 -translate-y-16 -translate-x-4 mx-auto border border-slate-500 xl:p-2 opacity-0 group-hover:opacity-100 bg-astro_black shadow-black transition-opacity duration-300 ease-in-out">
