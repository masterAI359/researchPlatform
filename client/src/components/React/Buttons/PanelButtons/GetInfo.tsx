...
import { selectingText } from "@/ReduxToolKit/Reducers/Investigate/WikipediaSlice";
...
export default function GetInfo () {
    ...
    return (
         <button
            onClick={() => dispatch(selectingText())}
