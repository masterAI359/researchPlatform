...
export default function TakeNotes({ }) {
    ...
    return (
        ...
        ease-in-out group">
            ...
            <div className="fixed bg-black shadow-thick rounded-md z-50 -translate-y-16 -translate-x-4 mx-auto border border-slate-500 xl:p-2 opacity-0 group-hover:opacity-100 bg-astro_black transition-opacity duration-300 ease-in-out">
