...
export default function SearchBlueSky () {
    ...
    return (
        <button 
        type="button" 
        className="rounded-full w-36 lg:w-52 h-auto p-2 bg-white text-white group
        md:hover-bg-white/10 transition-all ease-in-out duration-200 shadow-material_2
