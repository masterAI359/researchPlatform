...
export default function SaveArticle({ saveArticle, fillBookMark }) {




    return (
        <div onClick={() => saveArticle()} className="w-auto h-auto self-start flex items-center justify-start group relative cursor-pointer">
