...
export default function TakeNotes({ setTakingNotes }) {
    ...
    return (
        <button
            ...
            className="bg-button_gray w-auto h-auto fixed lg:left-[28rem] lg:bottom-12 
        rounded-lg hover:scale-125 hover:bg-button_blue transition-all duration-300 
        ease-in-out group">
            <div className="h-full w-full box-border mx-auto my-auto p-1.5">
