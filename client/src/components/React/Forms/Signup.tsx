...
export default function Signup() {
    ...
    const checkInput = () => {
        ...
        requiredInput(newEmail, secondPassword, setAcceptedInput)
    ...
    const submitAccountCreation = (e: any) => {
        ...
        acceptedInput ? createUser() : console.log('input not accepted')
    }
                                    ...
                                    <div>
                                        <label htmlFor="password" className="block mb-3 text-sm font-medium text-white">
                                            <div className="flex justify-between pr-2 gap-x-6 items-center">
                                                ...
                                                <div className="w-fit">
                                                    {acceptedInput === true && canSubmit !== false && <svg xmlns="http://www.w3.org/2000/svg" className={`icon icon-tabler icon-tabler-check text-green-500 mx-auto`} width={16} height={16} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <path d="M5 12l5 5l10 -10" />
                                                    </svg>}
                                                    {canSubmit === false && <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
