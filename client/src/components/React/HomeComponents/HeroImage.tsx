					...
					<div className='mk6'>
						...
						<div className='relative w-[75%] mt-8'>
							<input
								type='text'
								name='q'
								className='bg-black text-white w-full border-black h-12 shadow  p-4 rounded-full  focus:border-white transition-colors'
								placeholder='search'
							/>
							<button type='submit'>
								<svg
									className='text-[#B0BEC5] hover:text-white transition-colors h-5 w-5 absolute top-3.5 right-3 fill-current'
