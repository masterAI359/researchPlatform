      ...
      <div className="flex flex-col items-center w-full md:px-5 xs:px-0">
        ...
        rounded-lg xs:mb-2 lg:mb-4 flex flex-row xs:gap-x-4 md:gap-x-8 items-baseline lg:mt-10">
          <div className="w-fit flex justify-items-start">
            <h1 className="md:text-2xl tracking-tight font-light text-white pb-2 xs:text-md">Explore our biases
            </h1>
          </div>
        ...
        <div className="text-center w-full">
          ...
          <div
            id="take"
            className="block w-full xs:h-40 md:h-52 xl:h-96 text-md text-white bg-white/10 border-none focus:ring-1 focus:ring-white
