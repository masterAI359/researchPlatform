...
export default function MindNode1({ currentStep, setCurrentStep }) {
    ...
    return (
        <div className="bg-ebony w-52 h-fit p-3 relative left-40 top-8 flex items-center justify-beetween
            ...
            <motion.div
                ...
                className="flex items-center justify-self-start justify-center shrink-0 box-border xs:max-w-7 xs:max-h-7
                            lg:max-h-11 lg:max-w-11 xs:p-0.5 sm:p-1 md:1.5 lg:p-2 rounded-full z-10 hover:cursor-pointer transition-all duration-300 hover:scale-105"
                animate={{
            ...
            <h1 className="text-white text-sm font-light tracking tight">What are we investigating?</h1>
