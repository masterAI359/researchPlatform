...
export default function MindNode4({ currentStep }) {
    ...
    return (
        ...
        bg-ebony xl:w-36 xl:h-12 lg:w-32 lg:h-11 md:w-24 md:h-10 md:p-0.5 absolute bottom-16 xl:bottom-22 lg:bottom-16 left-1/2 left-1/2 transform -translate-x-1/2
