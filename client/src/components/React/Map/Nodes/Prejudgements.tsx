...
export default function Prejudgements({ currentStep }) {

    return (
        <div className='h-full w-fit absolute xs:left-1 xs:top-24 md:left-4 md:top-40'>
        ...
        transition-all duration-200 ease-in-out ${currentStep === 1 ? 'scale-110' : null}
         bg-ebony xs:h-12 xs:w-28 lg:w-52 lg:h-20 p-3 relative flex items-center justify-beetween
