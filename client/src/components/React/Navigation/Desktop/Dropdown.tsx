            ...
            <Link to={email ? '/Profile' : '/Login'} >
                ...
                >
                    <div className="w-full h-auto flex items-center">
                        <p className="text-white font-light text-sm group-hover:text-blue-400 transition-all duration-200 ease-in-out whitespace-nowrap">{email ? shortenedEmail : 'Log in'}</p>
                    </div>
