...
export default function TipTap() {
    ...
    return (<>
        <div className="control-group w-full flex justify-start bg-white/5 px-1">
            <div className="button-group text-white flex gap-x-2 ">
                <button
                    onClick={() => editor.chain().focus().toggleBulletList().run()}
                    className={editor.isActive('bulletList') ? 'is-active' : ''}
                >
                    <div className="max-h-9 max-w-9 p-1 hover:bg-white/10 transition-all duration-200 ease-in-out rounded-md">
        ...
        <EditorContent className="text-white focus:outline-none px-1 focus:border-none font-light tracking-tight cursor-text
