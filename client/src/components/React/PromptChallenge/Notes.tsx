...
export default function Notes({ notePosition, setNotePosition, constraints, notesRef, setTakingNotes }) {
    ...
    return (
        <motion.div
            ...
            shadow shadow-black pb-3 rounded-lg inset cursor-pointer
            flex flex-col">
            <div className="h-full w-full box-border flex flex-col justify-start">
                <div className="w-full max-h-fit flex justify-between bg-ebony/90 rounded-t-lg">
                    <div className="max-w-8 max-h-8 p-1 box-border rounded-md hover:bg-white/10 transition-all duration-200 ease-in-out">
                    ...
                    <div
                        ...
                        className="max-w-8 max-h-8 p-1 box-border rounded-md hover:bg-white/10 transition-all duration-200 ease-in-out">
                        <svg className="text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
