...
export default function SearchBox ({ isLoading, setIsLoading, articles, setArticles, readyToSelect,
  setReadyToSelect, isSubmitted, setIsSubmitted, query, setQuery, status }) {
...
const options: OptionsTypes =  {
  ...
  const interactive = status === "searchBox"
    ...
    return (
            <div className={`mx-auto absolute w-[75rem] 2xl:h-full opacity-0 transition-all ease-in delay-1000 duration-500 ${interactive ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'  }`}>
<div className="text-center w-full md:mx-auto">
      ...
      <p className="mt-5 text-white my-11">
       This is just some placeholder text, <br></br>
       I would like to use this space to suggest questions to consider to <br></br>
       the user, encouraging critical thinking at the point of the search for information.<br></br>
       This may be a more useful leveraging of AI than simply suggesting search queries<br></br>
       Though both might be possible to acheive, it will depend on the AI training limitations
      </p>
