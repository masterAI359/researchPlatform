  ...
  overflow-hidden">
        <div className="w-full box-border border-b h-fit border-white/10 flex flex-row justify-center items-baseline mb-5">
          <div className="self-center grow">
            <h1 className="text-4xl tracking-tight font-light text-white p-4">Explore our biases<br></br>
        ...
        <div className="text-center relative w-full">
          <textarea
            onChange={handleBias}
            id="take"
            className="block mx-auto w-11/12 md:h-52 text-md text-gray-900 bg-white/10 
