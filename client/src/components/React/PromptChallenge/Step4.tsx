        ...
        <div className="block h-full w-full">
            <div className="w-full box-border border-b h-fit border-white/10 flex flex-row justify-center items-baseline mb-5">
                <div className="self-center grow">
                    <h1 className="text-4xl tracking-tight font-light text-white p-4">Reflect on your stance<br></br>
                        <span className="text-zinc-400">what might change your mind?</span>
                    </h1>
                </div>
