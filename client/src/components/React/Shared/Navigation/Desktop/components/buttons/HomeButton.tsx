...
function HomeButton(): JSX.Element {
    ...
    return (
        <div className="flex flex-row items-center justify-between md:justify-start">
            <Link className="flex flex-row items-center justify-between md:justify-start" to={'/'} >
                <div className="text-white hover:text-white/50 items-center font-bold gap-3 inline-flex text-lg" title="link to home" aria-label="your label">
...
c-73.1,86.1-213,87.5-312.5,3.1s-121-222.7-47.9-308.8S314.3-7.8,413.8,76.6z" />
                    ...
                    <span className="font-light">elenchus</span>
                </div>
            </Link>
