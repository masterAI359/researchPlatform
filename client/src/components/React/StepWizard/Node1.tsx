...
export default function Node1({ setCurrentStep, currentStep }) {
    ...
    return (
        <li className="flex flex-col md:w-full xs:w-full xs:h-20 lg:h-28 items-center">
            <div className="flex items-center justify-center w-full h-full box-border">
                <motion.div
                    ...
                    className="flex items-center justify-self-start justify-center shrink-0 box-border xs:max-w-7 xs:max-h-7
                            lg:max-h-10 lg:max-w-10  rounded-full z-40 hover:cursor-pointer transition-all duration-300 hover:scale-110"
                    animate={{
                    ...
                    <svg className="h-full w-full xs:p-1 md:p-1.5 box-border" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
            ...
            <motion.div
                className="md:text-sm xs:text-[0.6rem] text-center bg-transparent
                        text-white self-start w-full xs:-translate-x-5"
