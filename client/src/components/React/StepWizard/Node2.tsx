        ...
        <li className="flex flex-col md:w-full xs:w-full xs:h-20 lg:h-28 items-center">
            <div className="flex  items-center justify-center w-full h-full relative">
                <motion.div
                 ...
                 lg:max-h-10 lg:max-w-10  shrink-0 z-40 hover:cursor-pointer transition-all duration-300 hover:scale-110"
                    animate={{
            ...
            <motion.div
                className="left-0 md:text-sm xs:text-[0.6rem] text-center bg-transparent
            text-white self-start w-fit xs:translate-x-5"
