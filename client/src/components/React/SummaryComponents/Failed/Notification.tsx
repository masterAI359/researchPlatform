...
export default function Notification({ notification, failedNotifications, setFailedNotifications }) {
    ...
    return (
        <motion.li
            ...
            className="xs:max-w-72 xs:max-h-32 md:max-w-44 xl:max-w-[29rem] xl:min-h-40 px-3 h-auto bg-ebony rounded-2xl xl:py-3 lg:py-2 cursor-pointer flex content-start">
