        ...
        <AnimatePresence>
            {showing && (
                <motion.li
                    ...
                    className="xs:max-w-72 xs:max-h-32 md:max-w-44 xl:max-w-[29rem] xl:min-h-36 px-3 h-auto bg-ebony rounded-2xl py-2 cursor-pointer flex content-start">
                    ...
                    <div className="min-h-full w-full box-border flex gap-x-2 xl:my-2 relative">
                        <div className="flex flex-col w-full xs:h-fit md:h-full md:gap-y-4 xs:gap-y-2">
                            <div className="flex gap-x-2 h-fit items-start xs:w-full md:w-3/4 box-border">
                            ...
                            <div>
                                <button className="bg-white/10 text-white rounded-full xs:w-24 md:w-28 border-transparent md:p-2 xs:p-1
                    ...
                    <div className="justify-self-end relative w-auto h-full box-border">
                        <div
                            ...
                            className="md:w-8 md:h-8 xs:h-5 xs:h-5 rounded-md hover:bg-white/10 xs:p-0 md:p-1 transition-all ease-in-out duration-200 top-0 right-0">
