...
export default function StepsEditor({ setterFunction, context }) {
    ...
    return (
        <div className="w-full h-full box-border mx-auto">
            <div className="control-group w-full flex px-1 bg-white rounded-t-lg">
                <div className="button-group w-full mx-auto text-white flex gap-x-3 py-1">
                    ...
                    >
                        <div className="max-h-7 shadow-thick  max-w-7 p-1  bg-mirage hover:bg-white transition-all duration-200 ease-in-out rounded-md cursor-pointer">
                            <svg className="text-white box-border group-hover:text-black transition-all duration-200 ease-in-out" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
            ...
            <div onClick={handleContainerClick} className="h-full w-full">
                <EditorContent style={{ textAlign: 'left', verticalAlign: 'top', minHeight: '90%', height: '100%', color: '#ffffff' }} editor={editor}
                    className="text-black xs:text-xs md:text-lg focus:outline-none px-1 focus:border-none font-thin font-serif tracking-tight cursor-text
