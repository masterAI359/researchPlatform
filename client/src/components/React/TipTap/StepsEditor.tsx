...
export default function StepsEditor({ setterFunction }) {
    ...
    return (
        <div className="w-full h-full box-border mx-auto">
            <div className="control-group w-full flex px-1">
                <div className="button-group w-full mx-auto text-white flex gap-x-2 pt-1">
                    <button
                        onClick={() => editor.chain().focus().toggleBlockquote().run()}
                    >
                        <div className="max-h-7 max-w-7 p-1 bg-white/10 hover:bg-white/20 transition-all duration-300 ease-in-out rounded-md cursor-pointer">
                    ...
                    >
                        <div className="max-h-7 max-w-7 p-1 bg-white/10 hover:bg-white/20 transition-all duration-200 ease-in-out rounded-md cursor-pointer">
            ...
            <EditorContent style={{ textAlign: 'left', verticalAlign: 'top', height: '100%' }} editor={editor}
                className="text-white text-lg focus:outline-none px-1 focus:border-none font-light font-serif tracking-tight cursor-text
