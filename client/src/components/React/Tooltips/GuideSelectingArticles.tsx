...
export default function GuideSelectingArticles({ }) {
    ...
    return (
        ...
        border border-astro_gray shadow-thick items-center border border-astro_gray shadow-thick after:content-[''] after:absolute after:bottom-[-10px] after:left-1/2 
