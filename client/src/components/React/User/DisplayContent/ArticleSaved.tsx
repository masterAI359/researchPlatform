...
export default function ArticleSaved({ article, index }) {
    ...
    return (
        <main key={index}
            ...
            <div className="w-fit grow h-fit xs:pt-4 md:pb-4 md:pl-4 xs:justify-self-start md:self-end">
            ...
            <div className="flex xs:w-full md:w-2/3 h-full md:items-end md:justify-end">
                <div className="flex flex-col h-auto w-auto">
                    <div className="flex xs:flex-col md:flex-row-reverse md:gap-x-4 md:justify-between h-full w-full items-center">
                        ...
                        <figcaption className='relative w-full lg:max-w-72 lg:min-w-72 lg:max-h-44 lg:min-h-44 xs:h-72  overflow-hidden'>
                            <div
                            ...
                            <div className='relative h-full w-full z-10 p-4'>
                                ...
                                md:gap-y-1 xs:items-center md:justify-center md:w-fit md:h-fit">
                                    <div className="flex flex-col items-center h-auto w-auto">
                                        <Bookmark dataToSave={dataToSave} showNotification={showNotification} setShowNotification={setShowNotification} />
                                    </div>
