...
export default function BackToSavedResearch() {
    ...
    return (
         <button onClick={backToSaved} className="absolute z-50 md:z-1 top-3 left-0 sm:left-0 md:left-0 lg:left-1.5 xl:left-2 2xl:left-6 md:fixed md:top-1/2 sm:left-12 xs:w-14 xs:h-8
        lg:w-16 lg:h-auto p-2 transition-all mx-auto flex
        duration-200 ease-in-out hover:bg-white/10 items-center group
        rounded-4xl">
             <div className="absolute p-1 bg-white z-50 opacity-0 transition-all duration-200 ease-in-out delay-500 md:group-hover:opacity-100 2xl:p-2 lg:bottom-16 2xl:left-2 xl:left-0 lg:left-2 bottom-12 -left-5
