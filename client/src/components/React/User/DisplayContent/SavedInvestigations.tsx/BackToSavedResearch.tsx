...
export default function BackToSavedResearch() {
    ...
    return (
        <button type="button" onClick={backToSaved} className="absolute top-4 left-6 md:top-1/3 md:left-0.5 z-30 md:fixed xl:top-1/2 xl:left-12 text-white font-light w-12 h-8 md:w-16 md:h-12 md:w-14
