      ...
      <div className="flex flex-col w-full">
        <div className="grid grid-cols-1 lg:grid-cols-4 pb-6 border-b border-white/10">
          <div className="items-center inline-flex lg:col-start-4 lg:ml-auto lg:px-2 mb-4 order-last space-x-2">
            ...
            <button className="bg-white/5 hover:bg-white/10 focus:bg-transparent rounded-2xl inline-flex items-center text-center text-white p-4 ring-1 ring-white/10">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-zinc-600 hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <li key={index} className="bg-ebony shadow-inset rounded-3xl p-4">
                    <figure>
                      <div>
                        ...
                        <p className="font-medium leading-6 text-white mt-24">{item.title}</p>
                        <p className="text-xs mt-2 text-zinc-300">{item.extract}</p>
                      </div>
                    </figure>
                  </li>
                ))}
