...
export default function NoSavedArticles() {
    ...
    return (
        <div className="w-full xl:w-2/3 h-fit flex items-center xl:justify-start justify-center py-16">
            <div className="w-fit flex flex-col items-center justify-start text-center">
                ...
                <p className="text-zinc-400 mb-6 font-light max-w-sm">
                    You haven't saved any articles. When you find something worth bookmarking, it'll show up here.
                </p>
