...
<div className="fixed bottom-0 block md:hidden z-50 w-full h-16 shadow-thick bg-gradient-to-tr from-ebony to-mirage">
  <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
    ...
    type="button" className="inline-flex flex-col items-center justify-center px-5   group">
      ...
      <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-all duration-200 ease-in-out">Investigations</span>
    </button>
    <button
     onClick={() => {
    ...
    type="button" className="inline-flex flex-col items-center justify-center px-5  group">
      ...
      <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-all duration-200 ease-in-out">Articles</span>
    </button>
    <button 
    onClick={() => {
    ...
    type="button" className="inline-flex flex-col items-center justify-center px-5  group">
      ...
      <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-all duration-200 ease-in-out">Settings</span>
    </button>
    <button onClick={() => dispatch(showSignOut(true))} type="button" className="inline-flex flex-col items-center justify-center px-5 group">
      ...
      <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 transition-all duration-200 ease-in-out">Log Out</span>
    </button>
  </div>
</div>
    )
