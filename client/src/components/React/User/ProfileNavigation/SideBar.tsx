...
export default function SideBar({ setDislayArticles, setDisplayInvestigations }) {
    ...
    return (
        ...
        <div className="xs:hidden md:block relative left-0">
            ...
            <aside id="separator-sidebar" className="fixed top-16 left-0 z-1 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
