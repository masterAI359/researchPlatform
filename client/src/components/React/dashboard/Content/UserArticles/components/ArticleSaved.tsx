...
function ArticleSaved({ children }: ArticleSavedComponent) {
  ...
  return (
    <div
      ...
      duration-200 ease-in-out overflow-hidden h-76 sm:h-36 md:h-40 
      lg:h-[12.8rem] 2xl:h-60 my-16 w-full sm:w-4/5 md:w-11/12 
      2xl:w-3/4 mx-auto"
    >
      <a
        className="flex flex-col-reverse justify-center
            ...
            items-center relative transition-opacity 
            duration-200 ease-in-out md:justify-items-end 
            md:items-start"
        href="#"
      >
        {children}
