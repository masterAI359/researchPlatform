...
function Title({ handleArticleSelection, article }) {
    ...
    return (
        <div className={`group transition-opacity w-full px-2 sm:px-0 sm:w-4/5 md:w-full duration-200 ease-in-out`}

            onClick={handleArticleSelection(article)}>
            <h3

                className="text-sm sm:text-sm w-11/12 md:w-full mt-6 tracking-tight font-light lg:text-lg xl:text-2xl 2xl:text-4xl
            ...
            <p className="text-zinc-400 text-xs mt-2 md:mt-4 w-full text-left">
